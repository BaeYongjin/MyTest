...
namespace AdManagerWebService.Common
{
	...
	/// </summary>
	public class MediaCodeService : System.Web.Services.WebService
	{
		private MediaCodeBiz mediacodeBiz = null;
		...
		{
			mediacodeBiz.GetMediaCodeList(header, mediacodeModel);
			return mediacodeModel;
		}
