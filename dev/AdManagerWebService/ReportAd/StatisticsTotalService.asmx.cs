...
namespace AdManagerWebService.ReportAd
{
	...
	/// <summary>
	/// StatisticsTotalService에 대한 요약 설명입니다.
	/// </summary>
	public class StatisticsTotalService : System.Web.Services.WebService
	{
		...
		{
			new StatisticsTotalBiz().GetStatisticsTotal(header, model);
			return model;
		}
	}
}
