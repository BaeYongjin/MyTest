...
namespace AdManagerClient.StatisticsDailyServicePloxy {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="StatisticsDailyServiceSoap", Namespace="http://advmgt.hanafostv.com/AdManagerWebService/")]
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(BaseModel))]
    public partial class StatisticsDailyService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public StatisticsDailyService() {
            this.Url = "http://localhost:8086/AdManagerWebserviceV5/ReportAd/StatisticsDailyService.asmx";
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://advmgt.hanafostv.com/AdManagerWebService/GetStatisticsDaily", RequestNamespace="http://advmgt.hanafostv.com/AdManagerWebService/", ResponseNamespace="http://advmgt.hanafostv.com/AdManagerWebService/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public StatisticsDailyModel GetStatisticsDaily(HeaderModel header, StatisticsDailyModel model) {
            object[] results = this.Invoke("GetStatisticsDaily", new object[] {
                        header,
                        model});
            return ((StatisticsDailyModel)(results[0]));
        }
        
        /// <remarks/>
        public System.IAsyncResult BeginGetStatisticsDaily(HeaderModel header, StatisticsDailyModel model, System.AsyncCallback callback, object asyncState) {
        ...
        /// <remarks/>
        public StatisticsDailyModel EndGetStatisticsDaily(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((StatisticsDailyModel)(results[0]));
        }
        
        /// <remarks/>
        public void GetStatisticsDailyAsync(HeaderModel header, StatisticsDailyModel model) {
            this.GetStatisticsDailyAsync(header, model, null);
        }
        
        /// <remarks/>
        public void GetStatisticsDailyAsync(HeaderModel header, StatisticsDailyModel model, object userState) {
            ...
            this.InvokeAsync("GetStatisticsDaily", new object[] {
                        header,
                        model}, this.GetStatisticsDailyOperationCompleted, userState);
        }
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(StatisticsDailyModel))]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Xml", "4.0.30319.18058")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://advmgt.hanafostv.com/AdManagerWebService/")]
    public partial class StatisticsDailyModel : BaseModel {
    ...
    public partial class GetStatisticsDailyCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public StatisticsDailyModel Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((StatisticsDailyModel)(this.results[0]));
            }
        }
    }
}
