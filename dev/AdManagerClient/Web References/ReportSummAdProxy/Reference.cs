...
namespace AdManagerClient.ReportSummAdProxy {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="ReportSummAdServiceSoap", Namespace="http://advmgt.hanafostv.com/AdManagerWebService/")]
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(BaseModel))]
    public partial class ReportSummAdService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public ReportSummAdService() {
            this.Url = "http://localhost:8086/AdManagerWebserviceV5/ReportSummaryAd/ReportSummAdService.a" +
                "smx";
        ...
        public RptAdBaseModel GetList(HeaderModel header, RptAdBaseModel model) {
            object[] results = this.Invoke("GetList", new object[] {
                        header,
                        model});
            return ((RptAdBaseModel)(results[0]));
        }
        
        /// <remarks/>
        public System.IAsyncResult BeginGetList(HeaderModel header, RptAdBaseModel model, System.AsyncCallback callback, object asyncState) {
        ...
        /// <remarks/>
        public RptAdBaseModel EndGetList(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((RptAdBaseModel)(results[0]));
        }
        
        /// <remarks/>
        public void GetListAsync(HeaderModel header, RptAdBaseModel model) {
            this.GetListAsync(header, model, null);
        }
        
        /// <remarks/>
        public void GetListAsync(HeaderModel header, RptAdBaseModel model, object userState) {
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(RptAdBaseModel))]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Xml", "4.0.30319.18058")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://advmgt.hanafostv.com/AdManagerWebService/")]
    public partial class RptAdBaseModel : BaseModel {
    ...
    public partial class GetListCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public RptAdBaseModel Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((RptAdBaseModel)(this.results[0]));
            }
        }
    }
}
