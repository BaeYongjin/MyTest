// ===============================================================================
//
// DailyAdExecSummaryRptControl.cs
//
// 광고일간레포트 컨트롤을 정의합니다. 
//
// ===============================================================================
...
namespace AdManagerClient
{
	...
	/// 광고별 시청현황 집계 관리 컨트롤
	/// </summary>
    public class DailyAdExecSummaryRptControl : System.Windows.Forms.UserControl, IUserControl
	{
		#region 이벤트핸들러
		...
		// 사용할 정보모델
		DailyAdExecSummaryRptModel dailyAdExecSummaryRptModel = new DailyAdExecSummaryRptModel();	// 광고일간레포트 모델
		...
		private AdManagerClient._51_ReportSummaryAd._04_DailyAdExecSummaryRpt.DailyAdExecSummaryRptDs dailyAdExecSummaryRptDs;
		private System.ComponentModel.IContainer components;

		public DailyAdExecSummaryRptControl()
		{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DailyAdExecSummaryRptControl));
            ...
            this.dailyAdExecSummaryRptDs = new AdManagerClient._51_ReportSummaryAd._04_DailyAdExecSummaryRpt.DailyAdExecSummaryRptDs();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.dailyAdExecSummaryRptDs)).BeginInit();
            ...
            this.uiPM.AddDockPanelInfo(new System.Guid("8e3140b9-bfcb-43af-b84e-2ee6cddf51dc"), new System.Guid("4c1253f5-927a-451c-a91f-16970d28ed20"), 250, true);
            this.uiPM.AddDockPanelInfo(new System.Guid("f75f97ec-19d0-4a97-a19b-7f30f998a81f"), new System.Guid("4c1253f5-927a-451c-a91f-16970d28ed20"), 315, true);
            ...
            this.uiPanelChoiceAdSchedule.Text = "일간광고집행 종합 보고서";
            // 
            // uiPanelSearch
            // 
            ...
            this.cbSearchDay.Location = new System.Drawing.Point(80, 10);
            ...
            // lbSearchDate
            // 
            this.lbSearchDate.Location = new System.Drawing.Point(8, 13);
            ...
            this.uiPanelList.Size = new System.Drawing.Size(1010, 269);
            ...
            this.uiPanelListContainer.Size = new System.Drawing.Size(1008, 245);
            ...
            this.grdExRpt.ScrollBars = Janus.Windows.GridEX.ScrollBars.Vertical;
            this.grdExRpt.SelectedInactiveFormatStyle.BackColor = System.Drawing.Color.Gold;
            this.grdExRpt.Size = new System.Drawing.Size(1008, 245);
            ...
            // dvReport
            // 
            this.dvReport.Table = this.dailyAdExecSummaryRptDs.DailyAd;
            // 
            // dailyAdExecSummaryRptDs
            // 
            this.dailyAdExecSummaryRptDs.DataSetName = "DailyAdExecSummaryRptDs";
            this.dailyAdExecSummaryRptDs.Locale = new System.Globalization.CultureInfo("en-US");
            this.dailyAdExecSummaryRptDs.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            // 
            // uiPanelList1
            // 
            this.uiPanelList1.CaptionHeight = 0;
            this.uiPanelList1.InnerContainer = this.uiPanelList1Container;
            this.uiPanelList1.Location = new System.Drawing.Point(0, 272);
            this.uiPanelList1.Name = "uiPanelList1";
            this.uiPanelList1.Size = new System.Drawing.Size(1010, 338);
            this.uiPanelList1.TabIndex = 4;
            this.uiPanelList1.Text = "uiPanelList1";
            // 
            // uiPanelList1Container
            // 
            this.uiPanelList1Container.Controls.Add(this.panel1);
            this.uiPanelList1Container.Location = new System.Drawing.Point(1, 0);
            this.uiPanelList1Container.Name = "uiPanelList1Container";
            this.uiPanelList1Container.Size = new System.Drawing.Size(1008, 337);
            ...
            this.panel1.Size = new System.Drawing.Size(1008, 337);
            ...
            this.gridEX1.Size = new System.Drawing.Size(1008, 337);
            ...
            // dvAdItem
            // 
            this.dvAdItem.Table = this.dailyAdExecSummaryRptDs.AdItem;
            // 
            // grdExRepoert
            // 
            ...
            // 
            // DailyAdExecSummaryRptControl
            // 
            this.Controls.Add(this.uiPanelChoiceAdSchedule);
            this.Font = global::AdManagerClient.Properties.Settings.Default.Font1;
            this.Name = "DailyAdExecSummaryRptControl";
            ...
            ((System.ComponentModel.ISupportInitialize)(this.dailyAdExecSummaryRptDs)).EndInit();
		...
		private void SearchReport()
		{
			...
			{
				// 데이터모델 초기화
				dailyAdExecSummaryRptModel.Init();

				dailyAdExecSummaryRptModel.LogDay1	= cbSearchDay.Value.ToString("yyMMdd");

				//keyMediaName      = "";
				//keyReportDay   = "";

				uiPanelList.Text = "일간시청현황"; 

				//  일별 광고시청집계조회 서비스를 호출한다.
				new DailyAdExecSummaryRptManager(systemModel, commonModel).GetDailyAdExecSummary(dailyAdExecSummaryRptModel);
		
				if (dailyAdExecSummaryRptModel.ResultCD.Equals("0000"))
				{
					Utility.SetDataTable(dailyAdExecSummaryRptDs.DailyAd, dailyAdExecSummaryRptModel.ReportDataSet);	
					Utility.SetDataTable(dailyAdExecSummaryRptDs.AdItem, dailyAdExecSummaryRptModel.ItemDataSet);	
					StatusMessage(dailyAdExecSummaryRptModel.ResultCnt + "건이 조회되었습니다.");

					keyReportDay   = cbSearchDay.Value.ToString("yyyy-MM-dd");

					uiPanelList.Text = "일간시청현황 : " + keyReportDay;
			...
			{
				FrameSystem.showMsgForm("광고일간집계 현황 조회오류", new string[] {fe.ErrCode, fe.ResultMsg});
			}
			catch(Exception ex)
			{
				FrameSystem.showMsgForm("광고일간집계 현황 조회오류",new string[] {"",ex.Message});
			}
			finally
			{
				ProgressStop();
		...
		{	
			...
			{	
				...
				// 타이틀 작성
				oSheet.Cells[TitleRow,1] = "일간광고집행종합보고서";
				...
				// 헤더 정보 작성
				//oSheet.Cells[HeaderRow,1] = "일간광고집행종합보고서";
				//oRng = oSheet.get_Range(GetColumnIndex(1)+Convert.ToString(HeaderRow), GetColumnIndex(7)+Convert.ToString(HeaderRow));
				//oRng.Merge(true);
				
				HeaderCount = 1;
				oSheet.Cells[HeaderRow,HeaderCount++] = "일자구분";
				oSheet.Cells[HeaderRow,HeaderCount++] = "총가구수";
				oSheet.Cells[HeaderRow,HeaderCount++] = "활성사용자";
				oSheet.Cells[HeaderRow,HeaderCount++] = "사용률(%)";
				oSheet.Cells[HeaderRow,HeaderCount++] = "채널HIT";
				oSheet.Cells[HeaderRow,HeaderCount++] = "광고HIT";
				oSheet.Cells[HeaderRow,HeaderCount++] = "광고빈도";
				...
				DataCount = 0;
				// 데이터 추출
				for (int inx =0; inx < dailyAdExecSummaryRptDs.DailyAd.Rows.Count; inx++)
				{		
					DataRow Row = dailyAdExecSummaryRptDs.DailyAd.Rows[inx];

					int ColCnt = 1;

					oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["일자구분"].ToString();								// 1  광고번호
					oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt64(Row["총가구수"].ToString());								// 2  광고명
					oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt64(Row["활성사용자"].ToString());				// 3  시청횟수
					oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToDecimal(Row["사용률"].ToString());			// 4  시청가구
					oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt64(Row["채널HIT"].ToString());			// 5  Rate
					oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt64(Row["광고HIT"].ToString());			// 6  Cove
					oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToDecimal(Row["광고빈도"].ToString());			// 7  Freq
...
//================================================================================================================================================
				...
				HeaderCount_r = 1;
				oSheet_r.Cells[HeaderRow_r,HeaderCount_r++] = "광고구분";
				oSheet_r.Cells[HeaderRow_r,HeaderCount_r++] = "노출물량";
				oSheet_r.Cells[HeaderRow_r,HeaderCount_r++] = "점유율";
				oSheet_r.Cells[HeaderRow_r,HeaderCount_r++] = "가구수";
				oSheet_r.Cells[HeaderRow_r,HeaderCount_r++] = "도달률";
				oSheet_r.Cells[HeaderRow_r,HeaderCount_r++] = "노출빈도";
				oSheet_r.Cells[HeaderRow_r,HeaderCount_r++] = "가구점유율";
				...
				DataCount_r = 0;
				// 데이터 추출
				for (int inx =0; inx < dailyAdExecSummaryRptDs.AdItem.Rows.Count; inx++)
				{		
					DataRow Row_r = dailyAdExecSummaryRptDs.AdItem.Rows[inx];

					int ColCnt = 1;
		
					oSheet_r.Cells[DataRow_r+DataCount_r,ColCnt++] = Row_r["광고구분"].ToString();								// 1  광고번호
					oSheet_r.Cells[DataRow_r+DataCount_r,ColCnt++] = Convert.ToInt64(Row_r["노출물량"].ToString());								// 2  광고명
					oSheet_r.Cells[DataRow_r+DataCount_r,ColCnt++] = Convert.ToDecimal(Row_r["점유율"].ToString());				// 3  시청횟수
					oSheet_r.Cells[DataRow_r+DataCount_r,ColCnt++] = Convert.ToDecimal(Row_r["가구수"].ToString());			// 4  시청가구
					oSheet_r.Cells[DataRow_r+DataCount_r,ColCnt++] = Convert.ToDecimal(Row_r["도달률"].ToString());			// 5  Rate
					oSheet_r.Cells[DataRow_r+DataCount_r,ColCnt++] = Convert.ToDecimal(Row_r["노출빈도"].ToString());			// 6  Cove
					oSheet_r.Cells[DataRow_r+DataCount_r,ColCnt++] = Convert.ToDecimal(Row_r["가구점유율"].ToString());			// 7  Freq
				...
				//광고번호 중앙정렬
				oRng_r = oSheet_r.get_Range(GetColumnIndex_r(1)+Convert.ToString(DataRow_r), GetColumnIndex_r(1)+Convert.ToString(DataRow_r+DataCount)); 
				oRng_r.HorizontalAlignment = Excel.XlHAlign.xlHAlignLeft;
								
				oRng_r = oSheet_r.get_Range(GetColumnIndex_r(2)+Convert.ToString(DataRow_r), GetColumnIndex_r(2)+Convert.ToString(DataRow_r+DataCount)); 
				oRng_r.HorizontalAlignment = Excel.XlHAlign.xlHAlignRight;
				oRng_r.NumberFormatLocal = "#,##0";

				//시청횟수 right정렬
				oRng_r = oSheet_r.get_Range(GetColumnIndex_r(3)+Convert.ToString(DataRow_r), GetColumnIndex_r(3)+Convert.ToString(DataRow_r+DataCount)); 
				oRng_r.HorizontalAlignment = Excel.XlHAlign.xlHAlignRight;
				oRng_r.NumberFormatLocal = "#,##0.00";

				//시청가구 right정렬
				oRng_r = oSheet_r.get_Range(GetColumnIndex_r(4)+Convert.ToString(DataRow_r), GetColumnIndex_r(4)+Convert.ToString(DataRow_r+DataCount)); 
				oRng_r.HorizontalAlignment = Excel.XlHAlign.xlHAlignRight;
				oRng_r.NumberFormatLocal = "#,##0";

				//rate right정렬
				oRng_r = oSheet_r.get_Range(GetColumnIndex_r(5)+Convert.ToString(DataRow_r), GetColumnIndex_r(5)+Convert.ToString(DataRow_r+DataCount)); 
				oRng_r.HorizontalAlignment = Excel.XlHAlign.xlHAlignRight;
				oRng_r.NumberFormatLocal = "#,##0.00";

				//Cove right정렬
				oRng_r = oSheet_r.get_Range(GetColumnIndex_r(6)+Convert.ToString(DataRow_r), GetColumnIndex_r(6)+Convert.ToString(DataRow_r+DataCount)); 
				oRng_r.HorizontalAlignment = Excel.XlHAlign.xlHAlignRight;
				oRng_r.NumberFormatLocal = "#,##0.00";

				//Freq right정렬
				oRng_r = oSheet_r.get_Range(GetColumnIndex_r(7)+Convert.ToString(DataRow_r), GetColumnIndex_r(7)+Convert.ToString(DataRow_r+DataCount)); 
				oRng_r.HorizontalAlignment = Excel.XlHAlign.xlHAlignRight;
				oRng_r.NumberFormatLocal = "#,##0.00";
