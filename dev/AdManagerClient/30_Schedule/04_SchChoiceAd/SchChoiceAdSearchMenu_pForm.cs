...
namespace AdManagerClient
{
    ...
    public class SchChoiceAdSearchMenu_pForm : System.Windows.Forms.Form
    {
        ...
        public SchChoiceAdSearchMenu_pForm(UserControl parent)
        {
            //
        ...
        /// 일반사용자
        /// </summary>
        public SchChoiceAdSearchMenu_pForm()
        {
            //
            // Windows Form 디자이너 지원에 필요합니다.
            //
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SchChoiceAdSearchMenu_pForm));
			...
			this.Name = "SchChoiceAdSearchMenu_pForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "편성메뉴선택";
			this.Load += new System.EventHandler(this.SchChoiceAdSearchMenu_pForm_Load);
        ...
        #region 컨트롤 로드
        private void SchChoiceAdSearchMenu_pForm_Load(object sender, System.EventArgs e)
        {
            // 데이터관리용 객체생성
        ...
        private void SearchGenre()
        {
            ...
            try
            {
                ...
                // 데이터모델에 전송할 내용을 셋트한다.
                genreGroupModel.MediaCode = Opener.MediaCode;
                ...
                // 컨텐츠목록조회 서비스를 호출한다.
                new GenreGroupSearch_pManager(systemModel,commonModel).GetGenreGroupList_p(genreGroupModel);
                ...
                if (genreGroupModel.ResultCD.Equals("0000"))
                {
                    ...
                    StatusMessage(genreGroupModel.ResultCnt + "건의 장르 정보가 조회되었습니다.");
                }
            }
		...
		/// <summary>
		/// 선택된 장르를 지정메뉴광고 상세내역에 편성
		/// </summary>
		private void AddSchChoiceAdDeailMenu()
		{
			StatusMessage("선택된 장르를 지정메뉴광고에 편성합니다.");
			...
			try
			{
				...
				if(SetCount > 0)
				{
//					MessageBox.Show("지정하신 메뉴에 편성되었습니다.", "메뉴광고편성",
