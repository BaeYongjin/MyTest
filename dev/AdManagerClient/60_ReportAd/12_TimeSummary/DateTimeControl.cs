...
namespace AdManagerClient
{
	...
	/// 광고별 시청현황 집계 관리 컨트롤
	/// </summary>
    public class DateTimeControl : System.Windows.Forms.UserControl, IUserControl
	{
        ...
        private string  winName     = "일별-시간별 집계";
		#endregion
		...
		private void InitializeComponent()
		{
            ...
            this.uiPanelChoiceAdSchedule.Text = "일자-시간별 집계";
            // 
            // uiPanelSearch
            // 
            ...
            // dvReport
            // 
            this.dvReport.Table = this.timeSummaryDs.DateTime;
            // 
            // timeSummaryDs
            // 
        ...
        private void ebItemName_ButtonClick(object sender, System.EventArgs e)
        {
            ...
            pForm.callType = "DateTimeControl";
        ...
        private void SearchReport()
        {
            ...
            try
            {
                ...
                //  전체통계 서비스를 호출한다.
                new TimeSummaryManager(systemModel,commonModel).GetDateTime( timeSummaryModel );

                if (timeSummaryModel.ResultCD.Equals("0000"))
                {
                    Utility.SetDataTable( timeSummaryDs.DateTime , timeSummaryModel.ReportDataSet);		
        ...
        {	
            ...
            {	
                ...
                // 타이틀 작성
                oSheet.Cells[TitleRow,1] = "일자-시간별 집계";
                ...
                HeaderCount = 1;
                oSheet.Cells[HeaderRow,HeaderCount++] = "일자";
                ...
                for (int inx =0; inx < timeSummaryDs.DateTime.Rows.Count; inx++)
                {		
                    DataRow Row = timeSummaryDs.DateTime.Rows[inx];

                    int ColCnt = 1;

                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Utility.reConvertDate(Row["LogDay"].ToString());
