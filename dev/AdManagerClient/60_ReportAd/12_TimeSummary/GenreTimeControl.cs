...
namespace AdManagerClient
{
	...
	/// 광고별 시청현황 집계 관리 컨트롤
	/// </summary>
    public class GenreTimeControl : System.Windows.Forms.UserControl, IUserControl
	{
		...
		// 사용할 정보모델
		private TimeSummaryModel timeSummaryModel  = new TimeSummaryModel();	// 프로그램별 광고시청집계모델
		private SummaryAdModel summaryAdModel  = new SummaryAdModel();	// 프로그램별 광고시청집계모델

		// 화면처리용 변수
		private bool    canRead     = false;
		private bool    canPrint    = false;
        private string  winName     = "장르-시간별 집계";
		...
		private AdManagerClient._60_ReportAd._12_TimeSummary.TimeSummaryDs timeSummaryDs;
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(GenreTimeControl));
            ...
            this.timeSummaryDs = new AdManagerClient._60_ReportAd._12_TimeSummary.TimeSummaryDs();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.timeSummaryDs)).BeginInit();
            ...
            this.uiPanelChoiceAdSchedule.Text = "장르-시간별 집계";
            // 
            // uiPanelSearch
            // 
            ...
            this.grdExReport.BuiltInTextsData = "<LocalizableData ID=\"LocalizableStrings\" Collection=\"true\"><GroupByBoxInfo>그룹핑할 항" +
    "목의 헤더를 이곳으로 드레그 하십시요</GroupByBoxInfo></LocalizableData>";
            ...
            this.grdExReport.EnterKeyBehavior = Janus.Windows.GridEX.EnterKeyBehavior.None;
            ...
            this.grdExReport.GroupTotals = Janus.Windows.GridEX.GroupTotals.Always;
            ...
            this.grdExReport.ScrollBars = Janus.Windows.GridEX.ScrollBars.Both;
            ...
            // dvReport
            // 
            this.dvReport.Table = this.timeSummaryDs.GenreTime;
            // 
            // timeSummaryDs
            // 
            this.timeSummaryDs.DataSetName = "TimeSummaryDs";
            this.timeSummaryDs.Locale = new System.Globalization.CultureInfo("en-US");
            this.timeSummaryDs.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            // 
            // grdExRepoert
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.timeSummaryDs)).EndInit();
        ...
        private void ebItemName_ButtonClick(object sender, System.EventArgs e)
        {
            ...
            pForm.callType = "GenreTimeControl";
        ...
        private void SearchReport()
        {
            ...
            {
                // 데이터모델 초기화
                timeSummaryModel.Init();
                timeSummaryModel.StartDay  	 =  cbSearchStartDay.Value.ToString("yyMMdd");
                timeSummaryModel.EndDay  	 =  cbSearchEndDay.Value.ToString("yyMMdd");
                timeSummaryModel.AdList      =  _itemList;
				
                uiPanelList.Text = winName;

                //  전체통계 서비스를 호출한다.
                new TimeSummaryManager(systemModel,commonModel).GetGenreTime( timeSummaryModel );

                if (timeSummaryModel.ResultCD.Equals("0000"))
                {
                    Utility.SetDataTable( timeSummaryDs.GenreTime , timeSummaryModel.ReportDataSet);		
                    StatusMessage(timeSummaryModel.ResultCnt + "건이 조회되었습니다.");		
        ...
        {	
            ...
            {	
                ...
                // 타이틀 작성
                oSheet.Cells[TitleRow,1] = "장르-시간별 집계";
                ...
                DataCount = 0;
                // 데이터 추출
                for (int inx =0; inx < timeSummaryDs.GenreTime.Rows.Count; inx++)
                {		
                    DataRow Row = timeSummaryDs.GenreTime.Rows[inx];

                    int ColCnt = 1;

                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["CategoryNm"].ToString();
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["GenreNm"].ToString();
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H00"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H01"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H02"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H03"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H04"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H05"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H06"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H07"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H08"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H09"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H10"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H11"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H12"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H13"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H14"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H15"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H16"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H17"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H18"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H19"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H20"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H21"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H22"].ToString());
                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Convert.ToInt32(Row["H23"].ToString());
                ...
                oRng = oSheet.get_Range(GetColumnIndex(2)+Convert.ToString(DataRow), GetColumnIndex(1)+Convert.ToString(DataRow+DataCount)); 
                oRng.HorizontalAlignment = Excel.XlHAlign.xlHAlignLeft;
                ...
                //광고번호 중앙정렬
                oRng = oSheet.get_Range(GetColumnIndex(26)+Convert.ToString(DataRow), GetColumnIndex(2)+Convert.ToString(DataRow+DataCount)); 
                oRng.HorizontalAlignment = Excel.XlHAlign.xlHAlignRight;
                oRng.NumberFormatLocal = "#,##0";
