...
namespace AdManagerClient
{
	...
	/// 광고별 시청현황 집계 관리 컨트롤
	/// </summary>
    public class ChannelTimeControl : System.Windows.Forms.UserControl, IUserControl
	{
		...
		// 사용할 정보모델
		TimeSummaryModel timeSummaryModel  = new TimeSummaryModel();	// 프로그램별 광고시청집계모델
		SummaryAdModel summaryAdModel  = new SummaryAdModel();	// 프로그램별 광고시청집계모델

		// 화면처리용 변수
		bool canRead			  = false;
		bool canPrint  = false;
        private string  winName     = "채널-시간별 집계";
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ChannelTimeControl));
            ...
            this.uiPanelChoiceAdSchedule.Text = "채널-시간별 집계";
            // 
            // uiPanelSearch
            // 
            ...
            this.grdExReport.FrozenColumns = 3;
            ...
            this.grdExReport.TreeLines = false;
            this.grdExReport.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007;
            // 
            // dvReport
            // 
            this.dvReport.Table = this.timeSummaryDs.ChannelTime;
            // 
            // timeSummaryDs
            // 
        ...
        private void ebItemName_ButtonClick(object sender, System.EventArgs e)
        {
            ...
            pForm.callType = "ChannelTimeControl";
        ...
        private void SearchReport()
        {
            ...
            try
            {
                ...
                //  전체통계 서비스를 호출한다.
                new TimeSummaryManager(systemModel,commonModel).GetChannelTime( timeSummaryModel );

                if (timeSummaryModel.ResultCD.Equals("0000"))
                {
                    Utility.SetDataTable( timeSummaryDs.ChannelTime , timeSummaryModel.ReportDataSet);		
        ...
        {	
            ...
            {	
                ...
                // 타이틀 작성
                oSheet.Cells[TitleRow,1] = winName;
                ...
                DataCount = 0;
                // 데이터 추출
                for (int inx =0; inx < timeSummaryDs.ChannelTime.Rows.Count; inx++)
                {		
                    DataRow Row = timeSummaryDs.ChannelTime.Rows[inx];
