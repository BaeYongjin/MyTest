...
namespace AdManagerClient
{
	...
	/// 광고별 시청현황 집계 관리 컨트롤
	/// </summary>
    public class AreaTimeControl : System.Windows.Forms.UserControl, IUserControl
	{
		...
		bool canRead			  = false;
		bool canPrint  = false;
        private string  winName     = "지역-시간별 집계";
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AreaTimeControl));
            ...
            this.uiPanelChoiceAdSchedule.Text = "지역-시간별 집계";
            // 
            // uiPanelSearch
            // 
            ...
            // dvReport
            // 
            this.dvReport.Table = this.timeSummaryDs.AreaTime;
            // 
            // timeSummaryDs
            // 
        ...
        private void ebItemName_ButtonClick(object sender, System.EventArgs e)
        {
            ...
            pForm.callType = "AreaTimeControl";
        ...
        private void SearchReport()
        {
            ...
            try
            {
                ...
                //  전체통계 서비스를 호출한다.
                new TimeSummaryManager(systemModel,commonModel).GetAreaTime( timeSummaryModel );

                if (timeSummaryModel.ResultCD.Equals("0000"))
                {
                    Utility.SetDataTable( timeSummaryDs.AreaTime , timeSummaryModel.ReportDataSet);		
        ...
        {	
            ...
            {	
                ...
                // 타이틀 작성
                oSheet.Cells[TitleRow,1] = "지역-시간별 집계";
                ...
                DataCount = 0;
                // 데이터 추출
                for (int inx =0; inx < timeSummaryDs.AreaTime.Rows.Count; inx++)
                {		
                    DataRow Row = timeSummaryDs.AreaTime.Rows[inx];

                    int ColCnt = 1;

                    oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["RegionName"].ToString();
