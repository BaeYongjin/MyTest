...
namespace AdManagerClient
{
	...
	/// 광고별 시청현황 집계 관리 컨트롤
	/// </summary>
    public class DateGenreControl : System.Windows.Forms.UserControl, IUserControl
	{
        ...
        private _60_ReportAd._13_DateSummary.DateSummaryDs dateSummaryDs1;
        private string  winName     = "장르-일자별 집계";
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DateGenreControl));
            ...
            this.dateSummaryDs1 = new AdManagerClient._60_ReportAd._13_DateSummary.DateSummaryDs();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.dateSummaryDs1)).BeginInit();
            ...
            this.uiPanelChoiceAdSchedule.Text = "장르-일자별 집계";
            // 
            // uiPanelSearch
            // 
            ...
            this.panel1.Controls.Add(this.ebContractName);
            this.panel1.Controls.Add(this.cbSearchStartDay);
            this.panel1.Controls.Add(this.lbSearchDate);
            this.panel1.Controls.Add(this.label5);
            this.panel1.Controls.Add(this.ebItemName);
            this.panel1.Controls.Add(this.label7);
            this.panel1.Controls.Add(this.label10);
            this.panel1.Controls.Add(this.cbSearchEndDay);
            ...
            this.cbSearchStartDay.TabIndex = 0;
            ...
            // label10
            // 
            this.label10.Location = new System.Drawing.Point(200, 5);
            ...
            this.cbSearchEndDay.TabIndex = 1;
            ...
            // label11
            // 
            this.label11.Location = new System.Drawing.Point(352, 5);
            ...
            // dvReport
            // 
            this.dvReport.Table = this.dateSummaryDs1.DateGenreData;
            // 
            // dateSummaryDs1
            // 
            this.dateSummaryDs1.DataSetName = "DateSummaryDs";
            this.dateSummaryDs1.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            // 
            // grdExReport
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.dateSummaryDs1)).EndInit();
        ...
        private void ebItemName_ButtonClick(object sender, System.EventArgs e)
        {
            ...
            pForm.callType = "DateGenreControl";
        ...
        private void SearchReport()
        {
            ...
            try
            {
                ...
                //  전체통계 서비스를 호출한다.
                new DateSummaryManager(systemModel,commonModel).GetDateGenre( dateSummaryModel );

                if (dateSummaryModel.ResultCD.Equals("0000"))
                {
                    Utility.SetDataTable( dateSummaryDs1.DateGenreData , dateSummaryModel.ReportDataSet);		
        ...
        {
            if (dateSummaryDs1.DateGenreData.Rows.Count > 0)
            {
                for (int inx = 0; inx < dateSummaryDs1.DateGenreData.Rows.Count; inx++)
                {
                    DataRow Row = dateSummaryDs1.DateGenreData.Rows[inx];

                    if (Row["Category"].ToString().Equals("0"))
                    {
                        int HeaderCount = 4;
                        for (int i = 0; i < dateSummaryDs1.Tables[0].Columns.Count - HeaderCount; i++)
                        {
        ...
        {	
            ...
            {	
                ...
                // 타이틀 작성
                oSheet.Cells[TitleRow,1] = "장르-일자별 집계";
                ...
                {		
                    ...
                    {								
                        ...
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["GenreNm"].ToString();								// 2  광고명
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d01"].ToString();								// 2  광고명
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d02"].ToString();								// 2  광고명
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d03"].ToString();								// 2  광고명
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d04"].ToString();								// 2  광고명
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d05"].ToString();				// 3  시청횟수
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d06"].ToString();			// 4  시청가구
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d07"].ToString();			// 5  Rate
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d08"].ToString();			// 6  Cove
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d09"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d10"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d11"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d12"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d13"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d14"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d15"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d16"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d17"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d18"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d19"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d20"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d21"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d22"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d23"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d24"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d25"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d26"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d27"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d28"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d29"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d30"].ToString();			// 7  Freq
                        oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["d31"].ToString();			// 7  Freq	
                        DataCount++;
                    }
                }
