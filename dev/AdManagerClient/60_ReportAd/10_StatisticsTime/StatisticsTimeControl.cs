...
namespace AdManagerClient
{
	...
	/// 광고별 시청현황 집계 관리 컨트롤
	/// </summary>
    public class StatisticsTimeControl : System.Windows.Forms.UserControl, IUserControl
	{
		#region 이벤트핸들러
		...
		// 사용할 정보모델
		StatisticsTimeModel mainModel  = new StatisticsTimeModel();	// 프로그램별 광고시청집계모델
		...
		private AdManagerClient.StatisticsTimeDs statisticsTimeDs;
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(StatisticsTimeControl));
            ...
            this.statisticsTimeDs = new AdManagerClient.StatisticsTimeDs();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.statisticsTimeDs)).BeginInit();
            ...
            this.ebContractAmt.Location = new System.Drawing.Point(594, 79);
            ...
            this.ebContractAmt.TabIndex = 192;
            ...
            // dvReport
            // 
            this.dvReport.Table = this.statisticsTimeDs.Report;
            // 
            // statisticsTimeDs
            // 
            this.statisticsTimeDs.DataSetName = "StatisticsTimeDs";
            this.statisticsTimeDs.Locale = new System.Globalization.CultureInfo("en-US");
            this.statisticsTimeDs.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            // 
            // grdExRepoert
            // 
            ...
            // 
            // StatisticsTimeControl
            // 
            this.Controls.Add(this.uiPanelChoiceAdSchedule);
            this.Name = "StatisticsTimeControl";
            this.Size = new System.Drawing.Size(1010, 677);
            this.Load += new System.EventHandler(this.StatisticsTimeControl_Load);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.statisticsTimeDs)).EndInit();
		...
		{	
			...
			{	
				...
				// 타이틀 작성
				oSheet.Cells[TitleRow,1] = "시간대별통계";
				...
				DataCount = 0;
				// 데이터 추출
				for (int inx =0; inx < statisticsTimeDs.Report.Rows.Count; inx++)
				{

					DataRow Row = statisticsTimeDs.Report.Rows[inx];			

					int ColCnt = 1;
					oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["TimeName"].ToString();						// 1  일자
        ...
        private void StatisticsTimeControl_Load(object sender, System.EventArgs e)
        {
        ...
        private void OnSearch(object sender, SearchReportData e)
        {
            ...
            try
            {
                ...
                uiPanelList.Text = "시간대통계"; 
			 
                //  전체통계 서비스를 호출한다.
                new StatisticsTimeManager(systemModel,commonModel).GetStatisticsTimeReport(mainModel);
	
                if (mainModel.ResultCD.Equals("0000"))
                {
                    Utility.SetDataTable(statisticsTimeDs.Report, mainModel.ReportDataSet);		
            ...
            {
                rptHeader.u_IsPrint = false;
                FrameSystem.showMsgForm("시간대 통계 조회오류", new string[] {fe.ErrCode, fe.ResultMsg});
            }
            catch(Exception ex)
            {
                rptHeader.u_IsPrint = false;
                FrameSystem.showMsgForm("시간대 통계 조회오류",new string[] {"",ex.Message});
            }
            finally
            {
                ProgressStop();
