...
namespace AdManagerClient
{
	...
	/// 광고별 시청현황 집계 관리 컨트롤
	/// </summary>
    public class TimeDayControl : System.Windows.Forms.UserControl, IUserControl
	{
		#region 이벤트핸들러
        ...
        private string  winName = "시간-요일별 집계";
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TimeDayControl));
            ...
            this.uiPanelChoiceAdSchedule.Text = "시간-요일별 집계";
            // 
            // uiPanelSearch
            // 
            ...
            this.ebContractName.TabIndex = 50;
            ...
            this.cbSearchStartDay.TabIndex = 40;
            ...
            this.cbSearchEndDay.TabIndex = 41;
            ...
            this.grdExReport.FocusCellFormatStyle.BackgroundGradientMode = Janus.Windows.GridEX.BackgroundGradientMode.Vertical;
            ...
            this.grdExReport.Font = new System.Drawing.Font("굴림체", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            // dvReport
            // 
            this.dvReport.Table = this.areaDayDs.TimeDay;
            // 
            // areaDayDs
            // 
        ...
        private void SearchReport()
        {
            ...
            try
            {
                ...
                //  전체통계 서비스를 호출한다.
                new AreaDayManager(systemModel,commonModel).GetTimeDay(areaDayModel);

                if (areaDayModel.ResultCD.Equals("0000"))
                {
                    Utility.SetDataTable(areaDayDs.TimeDay, areaDayModel.ReportDataSet);		
		...
		{	
			...
			{	
				...
				// 타이틀 작성
				oSheet.Cells[TitleRow,1] = "시간-요일별 집계";
				...
				// 헤더 정보 작성
				HeaderCount = 1;
				oSheet.Cells[HeaderRow,HeaderCount++] = "시간";
				...
				DataCount = 0;
				// 데이터 추출
				for (int inx =0; inx < areaDayDs.TimeDay.Rows.Count; inx++)
				{		
					DataRow Row = areaDayDs.TimeDay.Rows[inx];

					int ColCnt = 1;

					oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["Hour"].ToString();								// 1  광고번호
