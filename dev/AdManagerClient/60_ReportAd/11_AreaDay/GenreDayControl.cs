...
namespace AdManagerClient
{
	...
	/// 장르-요일별 집계
	/// </summary>
    public class GenreDayControl : System.Windows.Forms.UserControl, IUserControl
	{
        ...
        private string  winName     = "장르-요일별 집계";
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(GenreDayControl));
            ...
            this.uiPanelChoiceAdSchedule.Text = "장르-요일별 집계";
            // 
            // uiPanelSearch
            // 
            ...
            this.ebContractName.TabIndex = 61;
            ...
            this.cbSearchStartDay.TabIndex = 51;
            ...
            this.cbSearchEndDay.TabIndex = 52;
            ...
            // dvReport
            // 
            this.dvReport.Table = this.areaDayDs.GenreDay;
            // 
            // areaDayDs
            // 
        ...
        private void ebItemName_ButtonClick(object sender, System.EventArgs e)
        {
            ...
            pForm.callType = "GenreDayControl";
        ...
        private void SearchReport()
        {
            ...
            try
            {
                ...
                //  전체통계 서비스를 호출한다.
                new AreaDayManager(systemModel,commonModel).GetGenreDay(areaDayModel);

                if (areaDayModel.ResultCD.Equals("0000"))
                {
                    Utility.SetDataTable(areaDayDs.GenreDay, areaDayModel.ReportDataSet);		
        ...
        {	
            ...
            {	
                ...
                // 타이틀 작성
                oSheet.Cells[TitleRow,1] = "장르-요일별 집계";
                ...
                DataCount = 0;
                // 데이터 추출
                for (int inx =0; inx < areaDayDs.GenreDay.Rows.Count; inx++)
                {		
                    DataRow Row = areaDayDs.GenreDay.Rows[inx];
