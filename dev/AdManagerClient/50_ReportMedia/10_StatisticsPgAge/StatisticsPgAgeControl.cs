// ===============================================================================
//
// StatisticsPgAgeControl.cs
//
// 컨텐츠리포트 연령별통계 컨트롤을 정의합니다. 
//
// ===============================================================================
// Release history
// ===============================================================================
...
namespace AdManagerClient
{
    ...
    /// 컨텐츠리포트 연령별통계 관리 컨트롤
    /// </summary>
    public class StatisticsPgAgeControl : System.Windows.Forms.UserControl, IUserControl
    {
        #region 이벤트핸들러
        ...
        StatisticsPgModel statisticsPgModel = new StatisticsPgModel();	//공통모델
        ...
        private AdManagerClient._50_ReportMedia.ReportMediaDs statisticsPgAgeDs;
        private System.ComponentModel.IContainer components;

        public StatisticsPgAgeControl()
        {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(StatisticsPgAgeControl));
            ...
            this.statisticsPgAgeDs = new AdManagerClient._50_ReportMedia.ReportMediaDs();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.statisticsPgAgeDs)).BeginInit();
            ...
            this.uiPanelChoiceAdSchedule.Text = "연령별통계";
            // 
            // uiPanelSearch
            // 
            ...
            // ebSearchKey
            // 
            this.ebSearchKey.Location = new System.Drawing.Point(408, 8);
            ...
            this.rbSearchType_1WA.Size = new System.Drawing.Size(92, 23);
            this.rbSearchType_1WA.TabIndex = 6;
            this.rbSearchType_1WA.Text = "1주일 일평균";
            ...
            // rbSearchType_1MA
            // 
            this.rbSearchType_1MA.Location = new System.Drawing.Point(322, 1);
            this.rbSearchType_1MA.Name = "rbSearchType_1MA";
            this.rbSearchType_1MA.Size = new System.Drawing.Size(100, 23);
            this.rbSearchType_1MA.TabIndex = 6;
            this.rbSearchType_1MA.Text = "1개월 일평균";
            ...
            // rbSearchType_2MA
            // 
            this.rbSearchType_2MA.Location = new System.Drawing.Point(428, 1);
            this.rbSearchType_2MA.Name = "rbSearchType_2MA";
            this.rbSearchType_2MA.Size = new System.Drawing.Size(98, 23);
            this.rbSearchType_2MA.TabIndex = 6;
            this.rbSearchType_2MA.Text = "2개월 일평균";
            ...
            // rbSearchType_3MA
            // 
            this.rbSearchType_3MA.Location = new System.Drawing.Point(532, 1);
            this.rbSearchType_3MA.Name = "rbSearchType_3MA";
            this.rbSearchType_3MA.Size = new System.Drawing.Size(108, 23);
            this.rbSearchType_3MA.TabIndex = 6;
            this.rbSearchType_3MA.Text = "3개월 일평균";
            ...
            // dvReport
            // 
            this.dvReport.Table = this.statisticsPgAgeDs.ReportAge;
            // 
            // statisticsPgAgeDs
            // 
            this.statisticsPgAgeDs.DataSetName = "ReportMediaDs";
            this.statisticsPgAgeDs.Locale = new System.Globalization.CultureInfo("en-US");
            this.statisticsPgAgeDs.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            // 
            // grdExRepoert
            // 
            ...
            // 
            // StatisticsPgAgeControl
            // 
            this.Controls.Add(this.uiPanelChoiceAdSchedule);
            this.Name = "StatisticsPgAgeControl";
            ...
            ((System.ComponentModel.ISupportInitialize)(this.statisticsPgAgeDs)).EndInit();
        ...
        private void Init_MediaCode()
        {
            ...
            {
                // 데이터셋에 셋팅
                Utility.SetDataTable(statisticsPgAgeDs.Media, mediacodeModel.MediaCodeDataSet);
            }
            ...
            {
                DataRow row = statisticsPgAgeDs.Media.Rows[i];
        ...
        private void Init_cbSearchCategory()
        {
            ...
            new StatisticsPgAgeManager(systemModel, commonModel).GetCategoryList(statisticsPgWeekModel);

            if (statisticsPgWeekModel.ResultCD.Equals("0000"))
            {
                // 데이터셋에 셋팅
                Utility.SetDataTable(statisticsPgAgeDs.Category, statisticsPgWeekModel.CategoryDataSet);
            }
            ...
            new StatisticsPgAgeManager(systemModel, commonModel).GetGenreList(statisticsPgWeekModel);

            if (statisticsPgWeekModel.ResultCD.Equals("0000"))
            {
                // 데이터셋에 셋팅
                Utility.SetDataTable(statisticsPgAgeDs.Genre, statisticsPgWeekModel.GenreDataSet);
            }
            ...
            {
                DataRow row = statisticsPgAgeDs.Category.Rows[i];
        ...
        private void SetcbSearchGenre(string CategoryCode)
        {
            ...
            if (CategoryCode.Length > 0 && !CategoryCode.Equals("00"))
            {
                ...
                DataRow[] genreRow = statisticsPgAgeDs.Tables["Genre"].Select("CategoryCode = '" + CategoryCode + "'");
        ...
        private void InitCombo_Level()
        {
            ...
            {
                for (int i = 0; i < statisticsPgAgeDs.Media.Rows.Count; i++)
                {
                    DataRow row = statisticsPgAgeDs.Media.Rows[i];
        ...
        {
            StatusMessage("연령별통계을 조회합니다.");

            if (cbSearchMedia.SelectedValue.Equals("00"))
            {
                MessageBox.Show("매체를 선택해 주십시오.", "연령별통계",
                    MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            {
                // 데이터모델 초기화
                statisticsPgModel.Init();

                statisticsPgModel.SearchMediaCode = cbSearchMedia.SelectedValue.ToString();
                statisticsPgModel.SearchCategoryCode = cbSearchCategory.SelectedValue.ToString();
                statisticsPgModel.SearchGenreCode = cbSearchGenre.SelectedValue.ToString();
                statisticsPgModel.SearchStartDay = cbSearchStartDay.Value.ToString("yyMMdd");
                statisticsPgModel.SearchEndDay = cbSearchEndDay.Value.ToString("yyMMdd");

                // 데이터모델에 전송할 내용을 셋트한다.
                if (IsNewSearchKey)
                {
                    statisticsPgModel.SearchKey = "";
                }
                else
                {
                    statisticsPgModel.SearchKey = ebSearchKey.Text;
                }
                ...
                if (rbSearchType_C.Checked)
                {
                    statisticsPgModel.SearchType = "C"; // -- C:계약기간
                    IsAvg = false;
                }
                else if (rbSearchType_D.Checked)
                {
                    statisticsPgModel.SearchType = "D"; // -- D:일간
                    IsAvg = false;
                }
                else if (rbSearchType_W.Checked)
                {
                    statisticsPgModel.SearchType = "W"; // -- W:주간
                    IsAvg = false;
                }
                else if (rbSearchType_M.Checked)
                {
                    statisticsPgModel.SearchType = "M"; // -- M:월간
                    IsAvg = false;
                }
                else if (rbSearchType_1WA.Checked)
                {
                    statisticsPgModel.SearchType = "1WA"; // --1WA:일주일평균
                    IsAvg = true;
                }
                else if (rbSearchType_1MA.Checked)
                {
                    statisticsPgModel.SearchType = "1MA"; // --1MA:1개월평균
                    IsAvg = true;
                }
                else if (rbSearchType_2MA.Checked)
                {
                    statisticsPgModel.SearchType = "2MA"; // --2MA:2개월평균
                    IsAvg = true;
                }
                else if (rbSearchType_3MA.Checked)
                {
                    statisticsPgModel.SearchType = "3MA"; // --3MA:2개월평균
                    IsAvg = true;
                }
                ...
                uiPanelList.Text = "연령별통계";

                //  전체통계 서비스를 호출한다.
                if (IsAvg)
                {
                    new StatisticsPgAgeManager(systemModel, commonModel, "Age").GetStatisticsPgAgeReportAVG(statisticsPgModel);
                }
                else
                {
                    new StatisticsPgAgeManager(systemModel, commonModel, "Age").GetStatisticsPgAgeReport(statisticsPgModel);
                }

                if (statisticsPgModel.ResultCD.Equals("0000"))
                {
                    Utility.SetDataTable(statisticsPgAgeDs.ReportAge, statisticsPgModel.ReportDataSet);
                    StatusMessage(statisticsPgModel.ResultCnt + "건이 조회되었습니다.");
                    ...
                    keyReportType = statisticsPgModel.SearchType;


                    uiPanelList.Text = "연령별통계 : " + keyMediaName;

                    if (cbSearchCategory.SelectedItem.Value.ToString().Equals("00"))
                    {
                        uiPanelList.Text += " / 연령별 전체";
                    }
                    else
                    {
            ...
            {
                FrameSystem.showMsgForm("연령별통계 조회오류", new string[] { fe.ErrCode, fe.ResultMsg });
            }
            catch (Exception ex)
            {
                FrameSystem.showMsgForm("연령별통계 조회오류", new string[] { "", ex.Message });
            }
            finally
            {
                ProgressStop();
        ...
        private void btnExcel_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                // 헤더 정보 작성
                HeaderCount = 1;
                oSheet.Cells[HeaderRow, HeaderCount++] = "연령대";
                ...
                // 데이터 추출
                for (int inx = 0; inx < statisticsPgAgeDs.ReportAge.Rows.Count; inx++)
                {

                    DataRow Row = statisticsPgAgeDs.ReportAge.Rows[inx];

                    int ColCnt = 1;

                    oSheet.Cells[DataRow + DataCount, ColCnt++] = Row["SummaryName"].ToString();				    // 1  연령대
