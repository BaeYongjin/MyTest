// ===============================================================================
//
// StatisticsPgCategoryControl.cs
//
// 컨텐츠리포트 카테고리통계 컨트롤을 정의합니다. 
//
// ===============================================================================
// Release history
// 2010/07/22 유/무료 Hit분리처리
// ===============================================================================
...
namespace AdManagerClient
{
    ...
    /// 컨텐츠통계 카테고리통계 관리 컨트롤
    /// </summary>
    public class StatisticsPgCategoryControl : System.Windows.Forms.UserControl, IUserControl
    {
        #region 이벤트핸들러
        ...
        // 사용할 정보모델
        StatisticsPgCategoryModel statisticsPgCategoryModel = new StatisticsPgCategoryModel();	// 컨텐츠 카테고리별통계 모델
        ...
        private AdManagerClient._50_ReportMedia.ReportMediaDs statisticsPgCategoryDs;
        private System.ComponentModel.IContainer components;

        public StatisticsPgCategoryControl()
        {
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(StatisticsPgCategoryControl));
			...
			this.statisticsPgCategoryDs = new AdManagerClient._50_ReportMedia.ReportMediaDs();
			...
			((System.ComponentModel.ISupportInitialize)(this.statisticsPgCategoryDs)).BeginInit();
			...
			this.uiPanelChoiceAdSchedule.Text = "카테고리별통계";
			// 
			// uiPanelSearch
			// 
			...
			this.uiGroupBox1.Location = new System.Drawing.Point(216, 8);
			this.uiGroupBox1.Name = "uiGroupBox1";
			this.uiGroupBox1.Size = new System.Drawing.Size(336, 24);
			this.uiGroupBox1.TabIndex = 2;
			// 
			// rbSearchType_W
			// 
			this.rbSearchType_W.Checked = true;
			this.rbSearchType_W.Location = new System.Drawing.Point(144, 3);
			this.rbSearchType_W.Name = "rbSearchType_W";
			this.rbSearchType_W.Size = new System.Drawing.Size(48, 18);
			...
			this.rbSearchType_C.Location = new System.Drawing.Point(0, 3);
			this.rbSearchType_C.Name = "rbSearchType_C";
			this.rbSearchType_C.Size = new System.Drawing.Size(72, 18);
			...
			// rbSearchType_M
			// 
			this.rbSearchType_M.Location = new System.Drawing.Point(200, 3);
			this.rbSearchType_M.Name = "rbSearchType_M";
			this.rbSearchType_M.Size = new System.Drawing.Size(48, 18);
			...
			// rbSearchType_D
			// 
			this.rbSearchType_D.Location = new System.Drawing.Point(80, 3);
			this.rbSearchType_D.Name = "rbSearchType_D";
			this.rbSearchType_D.Size = new System.Drawing.Size(56, 18);
			...
			this.cbSearchStartDay.Location = new System.Drawing.Point(216, 32);
			...
			// lbSearchDate
			// 
			this.lbSearchDate.Location = new System.Drawing.Point(128, 32);
			...
			this.cbSearchEndDay.Location = new System.Drawing.Point(352, 32);
			...
			// label11
			// 
			this.label11.Location = new System.Drawing.Point(456, 32);
			...
			// dvReport
			// 
			this.dvReport.Table = this.statisticsPgCategoryDs.ReportCategory;
			// 
			// statisticsPgCategoryDs
			// 
			this.statisticsPgCategoryDs.DataSetName = "ReportMediaDs";
			this.statisticsPgCategoryDs.Locale = new System.Globalization.CultureInfo("en-US");
			this.statisticsPgCategoryDs.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
			// 
			// grdExRepoert
			// 
			...
			// 
			// StatisticsPgCategoryControl
			// 
			this.Controls.Add(this.uiPanelChoiceAdSchedule);
			this.Font = global::AdManagerClient.Properties.Settings.Default.Font1;
			this.Name = "StatisticsPgCategoryControl";
			...
			((System.ComponentModel.ISupportInitialize)(this.statisticsPgCategoryDs)).EndInit();
        ...
        private void Init_MediaCode()
        {
            ...
            {
                // 데이터셋에 셋팅
                Utility.SetDataTable(statisticsPgCategoryDs.Media, mediacodeModel.MediaCodeDataSet);
            }
            ...
            {
                DataRow row = statisticsPgCategoryDs.Media.Rows[i];
        ...
        private void InitCombo_Level()
        {
            ...
            {
                for (int i = 0; i < statisticsPgCategoryDs.Media.Rows.Count; i++)
                {
                    DataRow row = statisticsPgCategoryDs.Media.Rows[i];
        ...
        {
            StatusMessage("카테고리통계을 조회합니다.");

            if (cbSearchMedia.SelectedValue.Equals("00"))
            {
                MessageBox.Show("매체를 선택해 주십시오.", "카테고리통계", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            {
                // 데이터모델 초기화
                statisticsPgCategoryModel.Init();

                statisticsPgCategoryModel.SearchMediaCode = cbSearchMedia.SelectedValue.ToString();
                statisticsPgCategoryModel.SearchStartDay = cbSearchStartDay.Value.ToString("yyMMdd");
                statisticsPgCategoryModel.SearchEndDay = cbSearchEndDay.Value.ToString("yyMMdd");

                if (rbSearchType_C.Checked) statisticsPgCategoryModel.SearchType = "B"; // -- B:선택기간
                else if (rbSearchType_D.Checked) statisticsPgCategoryModel.SearchType = "D"; // -- D:일간
                else if (rbSearchType_W.Checked) statisticsPgCategoryModel.SearchType = "W"; // -- W:주간
                else if (rbSearchType_M.Checked) statisticsPgCategoryModel.SearchType = "M"; // -- M:월간

                keyMediaName = "";
                keyReportBgnDay = "";
                keyReportEndDay = "";

                uiPanelList.Text = "카테고리통계";

                //  전체통계 서비스를 호출한다.
                new StatisticsPgCategoryManager(systemModel, commonModel).GetStatisticsPgCategoryReport(statisticsPgCategoryModel);

                if (statisticsPgCategoryModel.ResultCD.Equals("0000"))
                {
                    Utility.SetDataTable(statisticsPgCategoryDs.ReportCategory, statisticsPgCategoryModel.ReportDataSet);
                    StatusMessage(statisticsPgCategoryModel.ResultCnt + "건이 조회되었습니다.");
                    ...
                    keyReportType = statisticsPgCategoryModel.SearchType;

                    uiPanelList.Text = "카테고리통계 : " + keyMediaName + " / " + keyReportBgnDay + " ~ " + keyReportEndDay;
        ...
        private void btnExcel_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                // 타이틀 작성
                oSheet.Cells[TitleRow, 1] = "카테고리통계";
                ...
                if (keyReportType.Equals("B")) ReportType += " (총기간)";
                ...
                //
                //				oRng.Borders.get_Item( Excel.XlBordersIndex.xlEdgeBottom ).LineStyle       = Excel.XlLineStyle.xlContinuous;	// 테두리속성 아래에 실선
                //				oRng.Borders.get_Item( Excel.XlBordersIndex.xlEdgeBottom ).Weight          = Excel.XlBorderWeight.xlThin;		// 테두리속성 아래에 가는선
                //				oRng.Borders.get_Item( Excel.XlBordersIndex.xlEdgeLeft ).LineStyle         = Excel.XlLineStyle.xlContinuous;
                //				oRng.Borders.get_Item( Excel.XlBordersIndex.xlEdgeLeft ).Weight            = Excel.XlBorderWeight.xlThin;
                //				oRng.Borders.get_Item( Excel.XlBordersIndex.xlEdgeRight ).LineStyle        = Excel.XlLineStyle.xlContinuous;
                //				oRng.Borders.get_Item( Excel.XlBordersIndex.xlEdgeRight ).Weight           = Excel.XlBorderWeight.xlThin;
                //				oRng.Borders.get_Item( Excel.XlBordersIndex.xlEdgeTop ).LineStyle          = Excel.XlLineStyle.xlContinuous;
                //				oRng.Borders.get_Item( Excel.XlBordersIndex.xlEdgeTop ).Weight             = Excel.XlBorderWeight.xlThin;
                //				oRng.Borders.get_Item( Excel.XlBordersIndex.xlInsideHorizontal ).LineStyle = Excel.XlLineStyle.xlContinuous;
                //				oRng.Borders.get_Item( Excel.XlBordersIndex.xlInsideHorizontal ).Weight    = Excel.XlBorderWeight.xlThin;
                //				oRng.Borders.get_Item( Excel.XlBordersIndex.xlInsideVertical ).LineStyle   = Excel.XlLineStyle.xlContinuous;
                //				oRng.Borders.get_Item( Excel.XlBordersIndex.xlInsideVertical ).Weight      = Excel.XlBorderWeight.xlThin;	
                ...
                oSheet.Cells[HeaderRow, HeaderCount++] = "Hit수";
                oSheet.Cells[HeaderRow, HeaderCount++] = "%";
                oSheet.Cells[HeaderRow, HeaderCount++] = "Hit(이어보기)";
                oSheet.Cells[HeaderRow, HeaderCount++] = "%";
                oSheet.Cells[HeaderRow, HeaderCount++] = "Hit수(유료)";
                oSheet.Cells[HeaderRow, HeaderCount++] = "%";
                ...
                // 데이터 추출
                for (int inx = 0; inx < statisticsPgCategoryDs.ReportCategory.Rows.Count; inx++)
                {
                    DataRow Row = statisticsPgCategoryDs.ReportCategory.Rows[inx];
                    ...
                    oSheet.Cells[DataRow + DataCount, ColCnt++] = Convert.ToInt32(Row["PgCnt"].ToString());		// 3  노출수
                    oSheet.Cells[DataRow + DataCount, ColCnt++] = Convert.ToDecimal(Row["PgRate"].ToString());		// 4  %
                    oSheet.Cells[DataRow + DataCount, ColCnt++] = Convert.ToInt32(Row["RePlayCnt"].ToString());	// 5  이어보기노출수
                    oSheet.Cells[DataRow + DataCount, ColCnt++] = Convert.ToDecimal(Row["RePlayRate"].ToString());	// 6  %
                    oSheet.Cells[DataRow + DataCount, ColCnt++] = Convert.ToInt32(Row["PPxCnt"].ToString());		// 7  노출수
                    oSheet.Cells[DataRow + DataCount, ColCnt++] = Convert.ToDecimal(Row["PPxRate"].ToString());	// 8  %
                    //oSheet.Cells[DataRow+DataCount,ColCnt++] = Row["RateBar"].ToString();						// 5  그래프

                    if (ORDCode.Equals("1")) // 카테고리합계이면
                    {
                        oRng = oSheet.get_Range(GetColumnIndex(1) + Convert.ToString(DataRow + DataCount), GetColumnIndex(8) + Convert.ToString(DataRow + DataCount));
                ...
                oRng = oSheet.get_Range(GetColumnIndex(5) + Convert.ToString(DataRow), GetColumnIndex(7) + Convert.ToString(DataRow + DataCount));	// 데이터의 범위
                oRng.NumberFormatLocal = "#,##0";

                // % 셀타입 설정
                oRng = oSheet.get_Range(GetColumnIndex(6) + Convert.ToString(DataRow), GetColumnIndex(8) + Convert.ToString(DataRow + DataCount));	// 데이터의 범위
                oRng.NumberFormatLocal = "#,##0.00";
