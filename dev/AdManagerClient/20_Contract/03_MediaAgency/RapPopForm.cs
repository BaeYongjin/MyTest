...
namespace AdManagerClient
{
	...
	public class RapPopForm : System.Windows.Forms.Form
	{
		...
		MediaAgencyControl RapCtl = null;
...
//		private System.ComponentModel.IContainer components;
		...
		public RapPopForm(MediaAgencyControl sender)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RapPopForm));
            ...
            // dvMediaAgency
            // 
            this.dvMediaAgency.Table = this.mediaAgencyDs.MediaRaps;
            // 
            // mediaAgencyDs
            // 
            ...
            this.grdExRapList.DataSource = this.dvMediaAgency;
            ...
            grdExRapList_Layout_0.DataSource = this.dvMediaAgency;
		...
		private void SearchRap()
		{
			...
			try
			{
				...
				if (mediarapcodeModel.ResultCD.Equals("0000"))
				{
					...
					StatusMessage(mediarapcodeModel.ResultCnt + "건의 컨텐츠 정보가 조회되었습니다.");
				}
			}
		...
		{
			string newKey = grdExRapList.SelectedItems[0].GetRow().Cells["RapCode"].Value.ToString();			
			string newKey_N = grdExRapList.SelectedItems[0].GetRow().Cells["RapName"].Value.ToString();			
			this.RapCtl.RapCode = newKey;				
			this.RapCtl.RapName = newKey_N;				
			this.Close();
		}
