...
{
	/// <summary>
	/// SlotChannelNoPopForm에 대한 요약 설명입니다.
	/// </summary>
	/// 



	public class SlotChannelNoPopForm : System.Windows.Forms.Form
	{
		...
		// 사용할 정보모델
		SlotOrganizationModel slotOrganizationModel  = new SlotOrganizationModel();	// 컨텐츠정보모델
		...
		public SlotChannelNoPopForm(SlotOrganizationControl sender)
		{
			//
			...
			SlotOrganizationCtl = sender;
		}

		/// <summary>
		/// 일반사용자
		/// </summary>
		public SlotChannelNoPopForm()
		{
			//
			// Windows Form 디자이너 지원에 필요합니다.
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SlotChannelNoPopForm));
            ...
            this.cbSearchMediaName.TabIndex = 37;
            ...
            this.cbSearchGenreName.TabIndex = 35;
            ...
            this.grdExChannelNoList.TabIndex = 12;
            ...
            this.Name = "SlotChannelNoPopForm";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "채널목록검색";
            this.Load += new System.EventHandler(this.SlotChannelNoPopForm_Load);
		...
		#region 컨트롤 로드
		private void SlotChannelNoPopForm_Load(object sender, System.EventArgs e)
		{
		...
		public void InitCombo_Category()
		{
			...
			{
				// 데이터셋에 셋팅
				//Utility.SetDataTable(channelSetDs1.Categorys, slotOrganizationModel.CategoryDataSet);	
			}
		...
		public void InitCombo_Genre()
		{
			...
			{
				// 데이터셋에 셋팅
				Utility.SetDataTable(channelSetDs1.Genres, slotOrganizationModel.GenreDataSet);	
			}
		...
		private void SearchChannelSet()
		{
			...
			try
			{
				...
				{
					slotOrganizationModel.SearchKey  = cbSearchMediaName.Text;
				}
				slotOrganizationModel.MediaCode_P = cbSearchMediaName.SelectedItem.Value.ToString();
				slotOrganizationModel.CategoryCode_P = cbSearchCategoryName.SelectedItem.Value.ToString();
				slotOrganizationModel.GenreCode_P = cbSearchGenreName.SelectedItem.Value.ToString();

				// 컨텐츠목록조회 서비스를 호출한다.
				//new SlotOrganizationManager(systemModel,commonModel).GetChannelNoPopList(slotOrganizationModel);

				if (slotOrganizationModel.ResultCD.Equals("0000"))
				{
					Utility.SetDataTable(channelSetDs1.ChannelSetPop, slotOrganizationModel.ChannelSetDataSet);				
					StatusMessage(slotOrganizationModel.ResultCnt + "건의 컨텐츠 정보가 조회되었습니다.");
				}
			}
		...
		private void btnOk_Click(object sender, System.EventArgs e)
		{
			...
			this.SlotOrganizationCtl.ChannelNo = newKey;				
			this.Close();
		}
