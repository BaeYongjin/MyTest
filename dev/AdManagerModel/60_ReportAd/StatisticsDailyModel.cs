...
{
	/// <summary>
	/// StatisticsDailyModel에 대한 요약 설명입니다.
	/// </summary>
	public class StatisticsDailyModel : BaseModel
	{

		// 조회용
		private string _SearchMediaCode		= null;	// 검색 매체
		private string _SearchContractSeq	= null;	// 조회 계약번호
		private string _CampaignCode        = null;	// 조회 캠패인번호
		...
		public StatisticsDailyModel() : base () 
		{
			Init();
		}
